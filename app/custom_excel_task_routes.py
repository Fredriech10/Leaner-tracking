...
RULES = {
    ...
    "formula_exact": ("Formulas", "Exact formula", "formula_exact"), "formula_references": ("Formulas", "Formula references", "formula_references"),
    ...
    "sorted_range": ("Data", "Sorted column range", "sorted_range"), "conditional_formatting_present": ("Data", "Conditional formatting present", "conditional_formatting_present"), "conditional_formatting_range": ("Data", "Conditional formatting range", "conditional_formatting_range"), "image_at_cell": ("Objects", "Image anchored at cell", "image_at_cell"), "chart_title": ("Objects", "Chart title", "chart_title"), "page_orientation": ("Print", "Page orientation", "page_orientation"), "fit_to_page": ("Print", "Fit worksheet to page", "fit_to_page"),
}
