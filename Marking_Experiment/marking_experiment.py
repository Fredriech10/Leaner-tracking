...
MARKING_SCHEMA: Dict[str, Any] = {
    "word": {
        "paragraph_formatting": {
            ...
            "left_indent": "value with unit cm",
            "right_indent": "value with unit cm",
            "first_line_indent": "value with unit cm",
            "hanging_indent": "value with unit cm",
            "right_to_left": "true/false",
            "keep_with_next": "true/false",
            "keep_lines_together": "true/false",
            "widow_orphan_control": "true/false",
            "page_break_before": "true/false",
            "outline_level": "outline level number",
            "tabs": "count/position_cm/alignment/leader",
        ...
        "page_layout": {
            ...
            "header_content": "contains text or bool",
            "footer_content": "contains text or bool",
            "header_differs": "true/false",
            "footer_differs": "true/false",
            "page_number_in_header": "true/false",
            "page_number_in_footer": "true/false",
            "page_number_format": "1|i|I|a|A",
            "page_break": "count or true/false",
            "section_page_break_type": "continuous|odd|even|nextPage",
            "line_numbers": "enabled/start/interval",
            "gutter_margin": "cm",
            "mirror_margins": "true/false",
            "page_color": "hex",
        },
        "design": {
...
FEEDBACK_TEMPLATES: Dict[Tuple[str, str], Dict[str, str]] = {
    ...
    ("paragraph_formatting", "hanging_indent"): {
        "pass": "Hanging indent correctly set to {expected} cm.",
        "fail": "Hanging indent was {actual} cm; expected {expected} cm.",
    },
    ("paragraph_formatting", "left_indent"): {
        "pass": "Left paragraph indent correctly set to {expected} cm.",
        "fail": "Left paragraph indent was {actual} cm; expected {expected} cm.",
    },
    ("paragraph_formatting", "right_indent"): {
        "pass": "Right paragraph indent correctly set to {expected} cm.",
        "fail": "Right paragraph indent was {actual} cm; expected {expected} cm.",
    },
    ("paragraph_formatting", "right_to_left"): {
        "pass": "Paragraph direction is right-to-left as expected.",
        "fail": "Paragraph direction is not right-to-left.",
    },
    ("paragraph_formatting", "keep_with_next"): {
        "pass": "Paragraph is correctly kept with the next paragraph.",
        "fail": "Paragraph is not kept with the next paragraph.",
    },
    ("paragraph_formatting", "keep_lines_together"): {
        "pass": "Paragraph lines are correctly kept together.",
        "fail": "Paragraph lines are not kept together.",
    },
    ("paragraph_formatting", "widow_orphan_control"): {
        "pass": "Widow/orphan control is enabled.",
        "fail": "Widow/orphan control is disabled.",
    },
    ("paragraph_formatting", "page_break_before"): {
        "pass": "Paragraph is correctly configured to start on a new page.",
        "fail": "Paragraph is not configured to start on a new page.",
    },
    ("paragraph_formatting", "outline_level"): {
        "pass": "Outline level correctly set to {expected}.",
        "fail": "Outline level was {actual}; expected {expected}.",
    },
    ("paragraph_formatting", "tabs"): {
        "pass": "Tab stops correctly configured.",
        "fail": "Tab stops did not match the expected configuration.",
    },
    ("font", "color"): {
